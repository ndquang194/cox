...
import { TransactionRepository, BookingRepository } from './repositories';
...
export async function main(options: ApplicationConfig = {}) {
  ...
  Schedule.agenda.on("ready", function () {
    let schedule = new Schedule(app.getSync<TransactionRepository>('repositories.TransactionRepository'), app.getSync<BookingRepository>('repositories.BookingRepository'));
    schedule.define();
